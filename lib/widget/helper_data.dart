...
class HelperData extends StatelessWidget {
  String title = "";
  List data = [];
  HelperData({ Key? key ,required this.title,required this.data}) : super(key: key);
        ...
        Padding(
          ...
          child: Card(
            ...
            child: ListTile(
              ...
              subtitle: Text(data[index]["sms"]==''?data[index]["data"]:data[index]["sms"]),
            ),
          ),
        )
      ),
